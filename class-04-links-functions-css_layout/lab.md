...
Since you have 5 hours in which to edit two projects, you'll need to work efficiently and limit your work to roughly two hours on a single person's project. Time management is critical.
